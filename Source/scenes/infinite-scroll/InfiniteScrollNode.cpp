...
void InfiniteScrollNode::addInfiniteScrollWithObjects(const ax::Vector<Sprite *> &objects, int z, Point ratio, Point pos, Point dir, Point relVel, Point padding)
{
...
void InfiniteScrollNode::addInfiniteScrollWithObjects(const ax::Vector<Sprite *> &objects, int z, Point ratio, Point pos, Point dir, Point relVel)
{
    this->addInfiniteScrollWithObjects(objects, z, ratio, pos, dir, relVel, Point(-1, -1));
}

void InfiniteScrollNode::addInfiniteScrollWithObjects(const ax::Vector<Sprite *> &objects, int z, Point ratio, Point pos, Point dir)
{
